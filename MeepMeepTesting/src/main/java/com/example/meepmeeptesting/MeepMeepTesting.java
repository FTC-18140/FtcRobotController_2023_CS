...
public class MeepMeepTesting
{
    ...
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBotLeft = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive ->
                                                  drive.trajectorySequenceBuilder(start)
                                                          .splineToSplineHeading(new Pose2d(26, -40, Math.toRadians(150)), Math.toRadians(0))
                                                          .splineToSplineHeading(new Pose2d(47, -46.5, Math.toRadians(90)), Math.toRadians(180))
