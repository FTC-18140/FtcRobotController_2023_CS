...
public class AutoRedRight_RoadRunner_TWO_PLUS_TWO extends OpMode {
    ...
    public void start(){
        ...
        to_stack = drive.trajectoryBuilder(truss1.end())
                ...
                .splineToConstantHeading(new Vector2d(-58, -41.5), Math.toRadians(150), SampleMecanumDrive.getVelocityConstraint(10, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        ...
        truss2 = drive.trajectoryBuilder(move_to_transfer.end(), true)
                .splineToConstantHeading(new Vector2d(-40, -64), Math.toRadians(0))
                .splineToConstantHeading(new Vector2d(24, -64), Math.toRadians(0))
                .build();
