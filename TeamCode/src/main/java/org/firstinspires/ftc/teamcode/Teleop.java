...
public class Teleop extends OpMode  {
    ...
    TBDGamepad tbdGamepad1 = new TBDGamepad(gamepad1);
    TBDGamepad tbdGamepad2 = new TBDGamepad(gamepad2);
...
//        }
        ...
        } else if (tbdGamepad2.getButton(Y)) {
        ...
        if (tbdGamepad2.getButton(LEFT_BUMPER) && tbdGamepad2.getButton(RIGHT_BUMPER))
        {
